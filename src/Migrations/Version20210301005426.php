 ...
 */
final class Version20210301005426 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE address_model (id INT AUTO_INCREMENT NOT NULL, countrydata_id INT DEFAULT NULL, user_id INT DEFAULT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, address VARCHAR(255) NOT NULL, country VARCHAR(255) NOT NULL, state VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, postcode VARCHAR(255) NOT NULL, phone_number VARCHAR(255) NOT NULL, address_line_2 VARCHAR(255) NOT NULL, INDEX IDX_E03005F98EBEADCC (countrydata_id), UNIQUE INDEX UNIQ_E03005F9A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_general_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE order_model (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, paypal_id INT DEFAULT NULL, address_id INT DEFAULT NULL, total INT NOT NULL, status VARCHAR(255) DEFAULT NULL, payment_method VARCHAR(255) NOT NULL, reference_id VARCHAR(50) NOT NULL, shipping DOUBLE PRECISION DEFAULT NULL, amount DOUBLE PRECISION DEFAULT NULL, subtotal DOUBLE PRECISION DEFAULT NULL, created_at DATETIME NOT NULL, update_at DATETIME NOT NULL, INDEX IDX_540B0624A76ED395 (user_id), UNIQUE INDEX UNIQ_540B0624349BE503 (paypal_id), INDEX IDX_540B0624F5B7AF75 (address_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_general_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE paypal_model (id INT AUTO_INCREMENT NOT NULL, paypalid VARCHAR(255) NOT NULL, href VARCHAR(255) NOT NULL, userid INT NOT NULL, status VARCHAR(255) DEFAULT NULL, order_model VARCHAR(255) DEFAULT NULL, amount VARCHAR(255) DEFAULT NULL, currency VARCHAR(255) DEFAULT NULL, paypalfee VARCHAR(255) DEFAULT NULL, refundhref VARCHAR(255) DEFAULT NULL, gross_amount DOUBLE PRECISION DEFAULT NULL, net_amount DOUBLE PRECISION DEFAULT NULL, gross_amount_currency VARCHAR(10) DEFAULT NULL, net_amount_currency VARCHAR(10) DEFAULT NULL, amount_currency VARCHAR(10) DEFAULT NULL, paypal_fee_currency VARCHAR(10) DEFAULT NULL, payment_date DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_general_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE visitor_of_page (id INT AUTO_INCREMENT NOT NULL, country VARCHAR(255) DEFAULT NULL, ip VARCHAR(255) DEFAULT NULL, state VARCHAR(255) DEFAULT NULL, latitude VARCHAR(255) DEFAULT NULL, longitute VARCHAR(255) DEFAULT NULL, postal VARCHAR(255) DEFAULT NULL, city VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, update_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_general_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE check_out_data DROP FOREIGN KEY FK_9900362EA76ED395');
        ...
        $this->addSql('DROP TABLE visitor_of_page');
    }
}
